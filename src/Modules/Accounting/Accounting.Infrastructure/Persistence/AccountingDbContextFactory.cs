...
/// <summary>
/// Design-time factory so <c>dotnet ef</c> can construct <see cref="AccountingDbContext"/> WITHOUT building the
...
public class AccountingDbContextFactory : IDesignTimeDbContextFactory<AccountingDbContext>
{
    public AccountingDbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<AccountingDbContext>()
            .UseNexcorePostgres(connection, typeof(AccountingDbContext).Assembly)
            .Options;
