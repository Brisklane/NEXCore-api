...
namespace Core.Infrastructure.Migrations
{
    ...
    [Migration("20260815153753_AddCompanyApps")]
    partial class AddCompanyApps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.CompanyApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("UninstalledByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("uninstalled_by_user_id");

                    b.HasKey("Id")
                        .HasName("pk_company_apps");

                    b.HasIndex("CompanyId", "AppKey")
                        .IsUnique()
                        .HasDatabaseName("ix_company_apps_company_id_app_key");

                    b.ToTable("company_apps", "core");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.CompanyApp", b =>
                {
                    b.HasOne("Core.Domain.Entities.Company", "Company")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_apps_companies_company_id");
