...
public interface IPriceListRepository : IRepository<PriceList>
{
    ...
    // ── Lines ─────────────────────────────────────────────────────────────
    Task<List<PriceListItem>> GetItemsAsync(Guid priceListId);
    Task<PriceListItem?> GetItemAsync(Guid itemId);
    Task AddItemAsync(PriceListItem item);
    Task RemoveItemAsync(PriceListItem item);
}
